...
def movie: IO[Response[IO]] =
  Ok:
    Movie(
      ...
      videoUrl = "TODO",
      wallpaperUrl = s"$imageHostBaseUrl/movie/wallpaper.webp",
      scenesUrls = List(
        s"$imageHostBaseUrl/movie/scene/s1.webp",
        s"$imageHostBaseUrl/movie/scene/s2.png",
        s"$imageHostBaseUrl/movie/scene/s3.jpg",
        s"$imageHostBaseUrl/movie/scene/s4.webp",
        s"$imageHostBaseUrl/movie/scene/s5.png",
        s"$imageHostBaseUrl/movie/scene/s6.avif",
        s"$imageHostBaseUrl/movie/scene/s7.jpg",
        s"$imageHostBaseUrl/movie/scene/s8.jpg",
        s"$imageHostBaseUrl/movie/scene/s9.png",
        s"$imageHostBaseUrl/movie/scene/s10.webp",
        s"$imageHostBaseUrl/movie/scene/s11.webp",
        s"$imageHostBaseUrl/movie/scene/s12.webp",
        s"$imageHostBaseUrl/movie/scene/s13.webp",
        s"$imageHostBaseUrl/movie/scene/s14.webp",
        s"$imageHostBaseUrl/movie/scene/s15.jpg",
      ),
      actors = List(
        Actor(
          name = "Sheryl Lee",
